module github.com/shono-io/leeroy

go 1.21

replace github.com/benthosdev/benthos/v4 => github.com/calmera/benthos/v4 v4.0.0-20230904091257-dea725961590
...
require (
	...
	github.com/benhoyt/goawk v1.24.0 // indirect
